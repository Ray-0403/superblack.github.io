...
if __name__ == '__main__':
    TEC= pd.read_csv('', usecols=[1], engine='python', skipfooter=0)
    dataset=TEC.values
    ...
    imfs = ceemdan.ceemdan(dataset.reshape(-1), None, 3)
    ...
    for imf in imfs:
        ...
        print('Train...')
        model.fit(trainX,trainY,epochs=500,verbose=2,batch_size=36)
